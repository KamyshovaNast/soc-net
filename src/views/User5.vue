<template>
  <div class="home">
        ...
        <v-row class="text-left">
            <v-col cols="2">
                <img src="https://randomuser.me/api/portraits/men/5.jpg" style="max-width: 100%">
            </v-col>
        ...
        <v-row>
          <v-col v-for="i in post"
            ...
            <v-card>
                <div class="postsHead">
                <v-avatar size="56">
                  <img class="avatar" alt="user" src="https://randomuser.me/api/portraits/men/5.jpg">
                </v-avatar>
                <div class="titl">
...
export default {
        ...
        methods: {
            ...
            getUserPost() {
                this.axios
                .get("http://jsonplaceholder.typicode.com/posts?userId=5")
