        ...
        <v-row>
          <v-col v-for="i in post"
            ...
            <v-card>
                <div class="postsHead">
                <v-avatar size="56">
                  <img class="avatar" alt="user" src="https://randomuser.me/api/portraits/men/7.jpg">
                </v-avatar>
                <div class="titl">
...
export default {
        ...
        methods: {
            getUser() {
                this.axios
                .get("http://jsonplaceholder.typicode.com/users/7")
                .then((response) => {this.dat = response.data})
            },
            getUserPost() {
                this.axios
                .get("http://jsonplaceholder.typicode.com/posts?userId=7")
